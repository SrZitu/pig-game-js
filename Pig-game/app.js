...
document.querySelector(".btn-roll").addEventListener("click", function (event) {
  if (gamePlaying) {
    ...
    //3. update the round score if the roll number was not one
...
document.querySelector(".btn-hold").addEventListener("click", function () {
  if (gamePlaying) {
    ...
    console.log(input);
    var winningValue;
    //undefined null 0 then false else always true
    if (input) {
      winningValue = input;
    } else {
      winningValue = 100;
...
// var x = document.querySelector("#score-0").textContent; //this is used as getter method
// console.log(x);
